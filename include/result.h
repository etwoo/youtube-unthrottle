...
typedef struct {
	enum {
		...
		ERR_JS_PLAYBACK_CONFIG_BASE64_DECODE,
		ERR_JS_PLAYBACK_CONFIG_ALLOC,
		ERR_JS_PROOF_OF_ORIGIN_BASE64_DECODE,
		ERR_JS_PROOF_OF_ORIGIN_ALLOC,
		ERR_JS_SABR_POST_BODY_ALLOC,
